...
{
    /// <inheritdoc />
    public partial class InitialPCSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "NV", new DateTime(1993, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "NVIDIA Corporation" },
                    { 2, "INTC", new DateTime(1968, 7, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Intel Corporation" },
                    { 3, "AMD", new DateTime(1969, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Advanced Micro Devices" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2026, 5, 20, 10, 0, 0, 0, DateTimeKind.Unspecified), "Workstation Ultra", 2, 48, 15.0 }
                });

            migrationBuilder.InsertData(
                table: "Components",
                columns: new[] { "Code", "ComponentManufacturerId", "ComponentTypesId", "Description", "Name" },
                values: new object[,]
                {
                    { "COMP000001", 1, 1, "Flagship GPU", "GeForce RTX 4090" },
                    { "COMP000002", 2, 2, "High-end CPU", "Core i9-14900K" },
                    { "COMP000003", 3, 3, "Fast system memory", "Vengeance DDR5 32GB" }
                });
